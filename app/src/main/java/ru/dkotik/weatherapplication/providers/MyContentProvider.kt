package ru.dkotik.weatherapplication.providers
...
import ru.dkotik.weatherapplication.room.*
    ...
    override fun query(
        ...
        selectionArgs: Array<String>?, sortOrder: String?
            ...
            val cursor = when (uriMatcher.match(uri)) {
                ...
                URI_ID -> { // Определяем id из URI адреса. Класс ContentUris помогает это сделать
